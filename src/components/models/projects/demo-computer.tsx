...
type GLTFResult = GLTF & {
  nodes: {
    ...
    // Add specific node types here if you want more type safety
    // Example:
    // Object_782_OnTheFly_bg_0: THREE.Mesh;
    // Object_788_Material057_0: THREE.Mesh;
    // ... and so on for all your nodes
  };
  materials: {
    [key: string]: THREE.Material;
    // Add specific material types here if you want more type safety
    // Example:
    // 'Material.074_40': THREE.Material;
    // 'Material.074_33': THREE.Material;
    // ... and so on for all your materials
  };
};

export function DemoComputer(props: React.ComponentProps<"group">) {
  const { nodes, materials } = useGLTF(
    "/models/gaming_desktop_pc.glb"
